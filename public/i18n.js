...
(function () {
  ...
  var MAP = {
    ...
    'Nothing moved in this tier in the last 24 hours.': '这个档位过去 24 小时没有成交。',
    'View tier on ORD.NET →': '在 ORD.NET 查看该档位 →',
    'Each sale appears once, in its most specific tier. Market data is informational, not investment advice.': '每笔成交只归入最精确的一个档位。行情仅供参考，不构成投资建议。',
    'Live feed temporarily unavailable': '实时成交暂时不可用',
    'The number tape is temporarily offline.': '编号成交带暂时离线。',
    'OpenNum profiles and registration are unaffected.': 'OpenNum 主页和注册功能不受影响。',
    'Check ORD.NET sales ↗': '查看 ORD.NET 成交 ↗',
  ...
  var REGEX = [
    ...
    [/^(\d+) confirmed sales? · Last 24h$/, '过去 24 小时 $1 笔确认成交'],
    [/^(\d+) confirmed sales? · Last 24h · Partial feed$/, '过去 24 小时 $1 笔确认成交 · 数据可能不完整'],
    [/^(\d+[mhd]) ago( · \$[\d,]+)?$/, '$1 前$2'],
    [/^View (\d+)$/, '查看 $1'],
